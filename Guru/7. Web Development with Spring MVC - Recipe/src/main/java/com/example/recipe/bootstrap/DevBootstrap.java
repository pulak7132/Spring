...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Recipe pGuacRecipe = new Recipe();
        pGuacRecipe.setCookTime(0);
        pGuacRecipe.setPrepTime(10);
        pGuacRecipe.setDescription("Perfect Guacamole");
        pGuacRecipe.setDifficulty(Difficulty.EASY);
        pGuacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                "\n" +
        ...
        guacNotes.setRecipe(pGuacRecipe);
        pGuacRecipe.setNotes(guacNotes);

        pGuacRecipe.getIngredients().add(new Ingredient("Ripe Avocados", new BigDecimal(2), eachUom, pGuacRecipe));
        pGuacRecipe.getIngredients().add(new Ingredient("Salt", new BigDecimal(.25), teapoonUom, pGuacRecipe));
        pGuacRecipe.getIngredients().add(new Ingredient("Lime Juice", new BigDecimal(1), tableSpoonUom, pGuacRecipe));
        pGuacRecipe.getIngredients().add(new Ingredient("Green Onions", new BigDecimal(2), tableSpoonUom, pGuacRecipe));
        pGuacRecipe.getIngredients().add(new Ingredient("serrano chilies", new BigDecimal(2), eachUom, pGuacRecipe));
        pGuacRecipe.getIngredients().add(new Ingredient("cilantro", new BigDecimal(2), tableSpoonUom, pGuacRecipe));
        pGuacRecipe.getIngredients().add(new Ingredient("freshly grated black pepper", new BigDecimal(2), dashUom, pGuacRecipe));
        pGuacRecipe.getIngredients().add(new Ingredient("Ripe Tomatoes", new BigDecimal(0.5), eachUom, pGuacRecipe));

        pGuacRecipe.getCategories().add(americanCategory);
        pGuacRecipe.getCategories().add(mexicanCategory);

        recipes.add(pGuacRecipe);
        //Yummy Tacos
